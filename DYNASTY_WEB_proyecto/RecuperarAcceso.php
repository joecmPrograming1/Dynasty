...
<head>
    ...
    <title>Dynasty | Recuperar acceso</title>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="canvas-menu mobile-menu">
            <ul>
                ...
                <li class="active"><a href="./RecuperarAcceso.php">Recuperar acceso</a></li>
            </ul>
        </nav>
                ...
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="auth-card">
                        ...
                        <form action="#" method="post" onsubmit="return mostrarMensaje(event);">
                            ...
                            <button type="submit" class="site-btn">Recuperar</button>
                        </form>
                        <div class="auth-links">
                            
                            <a href="./IniciarSesion.php">Volver al inicio de sesión</a>
                            <a href="./RegistrarUsuarios.php">Crear cuenta</a>
